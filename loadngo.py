...
import pickle
with open('encoder_inputs.pickle','rb') as f:
  encoder_inputs=pickle.load(f)
with open('tokenizer_inputs.pickle','rb') as f:
  tokenizer_inputs=pickle.load(f)
with open('num_words_inputs.pickle','rb') as f:
  num_words_inputs=pickle.load(f)
with open('sos_token_input.pickle','rb') as f:
  sos_token_input=pickle.load(f)
with open('eos_token_input.pickle','rb') as f:
  eos_token_input=pickle.load(f)
with open('del_idx_inputs.pickle','rb') as f:
  del_idx_inputs=pickle.load(f)
with open('decoder_outputs.pickle','rb') as f:
  decoder_outputs=pickle.load(f)
with open('tokenizer_outputs.pickle','rb') as f:
  tokenizer_outputs=pickle.load(f)
with open('num_words_output.pickle','rb') as f:
  num_words_output=pickle.load(f)
with open('sos_token_output.pickle','rb') as f:
  sos_token_output=pickle.load(f)
with open('eos_token_output.pickle','rb') as f:
  eos_token_output=pickle.load(f)
with open('del_idx_outputs.pickle','rb') as f:
  del_idx_outputs=pickle.load(f)

input_data=[]
target_data=[]
with open('correct1.txt') as f:
  for line in f:
    target_data.append(line)
with open('wrong1.txt') as f:
  for line in f:
...
transformer.load_weights("./trial/")
import random
for i in range(1):
